...
/* package omni-0.1.0.0 */
#ifndef VERSION_omni
#define VERSION_omni "0.1.0.0"
#endif /* VERSION_omni */
#ifndef MIN_VERSION_omni
#define MIN_VERSION_omni(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_omni */
...
#define CURRENT_COMPONENT_ID "omni-0.1.0.0-inplace-omni"
