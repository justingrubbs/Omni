...
description = unlines
  [ ""
  , "Welcome to The Quilterator!"
  , " Enter an expression or type :help for other commands. "
  ]
...
helpMsg = unlines
  ...
  , ":expr        - see a list of possible expressions."
  , ":quit        - quit."
  , ""
...
exprList = unlines
  [ ""
  , "Color              - names of standard colors"
  , "Number             - integer or float"
  , "Boolean            - True or False"
  , "RGB Values         - [r, g, b]"
  , "If                 - if <expr> then <expr> else <expr>"
  , "Quilt              - quilt <expr> <expr> <expr> <expr>"
  ]
      ...
      case minput of
        ...
        Just s       -> do
          ...
          shouldLoop <- case cmd of
            ...
            ":expr" -> (lift $ outputStrLn exprList) >> return True -- modeled from :help
